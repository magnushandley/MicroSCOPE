#ifndef PRESELECTION_MODULE_JSON_HXX
#define PRESELECTION_MODULE_JSON_HXX

#include "Framework/Module.hxx"
#include "Utils/Plotter.hxx"
#include "Utils/SURPRISEHelper.hxx"
...
class PreselectionModuleJSON final : public Module {
public:
    explicit PreselectionModuleJSON(const nlohmann::json& cfgJson);
